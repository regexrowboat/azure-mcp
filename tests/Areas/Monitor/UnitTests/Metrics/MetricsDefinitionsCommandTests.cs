...
public class MetricsDefinitionsCommandTests
{
    ...
    [Theory]
    [InlineData("--resource-name testresource --subscription sub1", true)]
    [InlineData("--subscription sub1", false)]
    [InlineData("--resource-name testresource", false)]
    [InlineData("", false)]
    ...
    public async Task ExecuteAsync_CallsServiceWithCorrectParameters()
    {
        ...
        var parseResult = _command.GetCommand().Parse(
            "--resource-name testresource --subscription sub1 --resource-type Microsoft.Storage/storageAccounts --metric-namespace Microsoft.Storage/storageAccounts --tenant tenant1");
    ...
    public async Task ExecuteAsync_WithSearchString_CallsServiceWithSearchParameter()
    {
        ...
        var context = new CommandContext(_serviceProvider);
        var parseResult = _command.GetCommand().Parse("--resource-name testresource --subscription sub1 --search-string cpu");
    ...
    public async Task ExecuteAsync_WithAllOptionalParameters_CallsServiceCorrectly()
    {
        ...
        var context = new CommandContext(_serviceProvider);
        var parseResult = _command.GetCommand().Parse(
            "--resource-name testresource --subscription sub1 --resource-type Microsoft.Storage/storageAccounts --metric-namespace Microsoft.Storage/storageAccounts --search-string memory --tenant tenant1 --limit 20");
    ...
    public async Task ExecuteAsync_WithResultsExceedingLimit_ShowsTruncationMessage()
    {
        ...
        var context = new CommandContext(_serviceProvider);
        var parseResult = _command.GetCommand().Parse("--resource-name testresource --subscription sub1 --limit 8");
