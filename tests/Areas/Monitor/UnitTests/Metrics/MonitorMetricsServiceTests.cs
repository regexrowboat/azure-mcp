...
public class MonitorMetricsServiceTests
{
    ...
    private const string TestResourceName = "teststorage";
    private const string TestResourceId = "/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/test-rg/providers/Microsoft.Storage/storageAccounts/teststorage";
    ...
    public async Task QueryMetricsAsync_WithInvalidInterval_ThrowsException(string invalidInterval)
    {
        ...
        Assert.Contains("ISO 8601 duration format", exception.Message);
    }
    ...
    public async Task QueryMetricsAsync_WithResourceResolutionFailure_ThrowsException()
    {
        ...
        Assert.Contains("Resource not found", exception.InnerException?.Message);
    }
    ...
    public async Task QueryMetricsAsync_WithClientCreationFailure_ThrowsException()
    {
        ...
        Assert.Contains("Error querying metrics", exception.Message);
        Assert.Contains("Authentication failed", exception.InnerException?.Message);
    }
