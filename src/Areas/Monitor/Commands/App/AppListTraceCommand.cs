...
namespace AzureMcp.Areas.Monitor.Commands.App
{
    ...
    : BaseAppCommand<AppListTraceOptions>
    {
        ...
        private const string CommandTitle = "App Diagnose List Traces";
        ...
        public override string Description =>
            ...
            --table=dependencies --filters="success='false'" 
            ...
            --table=requests --filters="duration=95p" --start-time="start of spike (ISO date)" --end-time="end of spike (ISO date)"
