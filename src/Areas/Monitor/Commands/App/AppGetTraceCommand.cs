...
using static AzureMcp.Areas.Monitor.Commands.App.AppGetSpanCommand;
    ...
    : BaseAppCommand<AppGetTraceOptions>
{
    ...
    private const string CommandTitle = "App Diagnose Get Trace";

    public override string Name => "get";

    // Define options from OptionDefinitions
    private readonly Option<string> _traceIdOption = MonitorOptionDefinitions.App.TraceId;
    private readonly Option<string> _spanIdOption = MonitorOptionDefinitions.App.SpanId;
